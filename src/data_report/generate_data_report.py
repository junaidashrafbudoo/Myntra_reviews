...
class DashboardGenerator:
    ...
    def display_general_info(self):
        ...
        self.data['Overall Rating'] = pd.to_numeric(self.data['Overall Rating'], errors='coerce')
        ...
        product_ratings = self.data.groupby('Product Name', as_index=False)['Overall Rating'].mean().dropna()

        fig_pie = px.pie(product_ratings, values='Overall Rating', names='Product Name',
    ...
    def display_product_sections(self):
        ...
        for i, product_name in enumerate(product_names):
            ...
            with columns[i]:
                ...
                avg_rating = product_data['Overall Rating'].mean()
